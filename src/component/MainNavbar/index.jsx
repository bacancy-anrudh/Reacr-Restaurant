...
const MainNavbar = () => {
  return (
    <Navbar expand="lg" variant="light" sticky="top" className='navbar-custom py-3'>
      <Container>
        ...
        <nav className='order-1 order-lg-2 border-0 ms-auto ms-lg-3 py-0'>
          <Nav className="ms-auto flex-row align-items-center">
            ...
            <Button as={NavLink} to="/signin" variant="primary" className="mx-3 me-lg-0">Sign In</Button>
          </Nav>
        </nav>
